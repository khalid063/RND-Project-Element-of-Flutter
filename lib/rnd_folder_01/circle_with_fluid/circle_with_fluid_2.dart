...
class SalesVolumePageTwo extends StatefulWidget {
  @override
  _SalesVolumePageTwoState createState() => _SalesVolumePageTwoState();
}

class _SalesVolumePageTwoState extends State<SalesVolumePageTwo> {
  double boxFluidValue = 70; // Change this value to adjust the filled percentage
