...
class AutoSerialNumberCreateScreenThree extends StatefulWidget {
  @override
  _AutoSerialNumberCreateScreenThreeState createState() => _AutoSerialNumberCreateScreenThreeState();
}

class _AutoSerialNumberCreateScreenThreeState extends State<AutoSerialNumberCreateScreenThree> {
  ...
  void initState() {
    ...
    // Generate and display the initial serial number when the app is first opened
    updateSerialNumber();
  }
