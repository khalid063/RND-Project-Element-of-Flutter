...
class CustomSnackbarFour extends StatefulWidget {
  @override
  State<CustomSnackbarFour> createState() => _CustomSnackbarFourState();
}

class _CustomSnackbarFourState extends State<CustomSnackbarFour> {
  @override
