...
class AlarmNotificationScreenTwo2 extends StatefulWidget {
  const AlarmNotificationScreenTwo2({Key? key}) : super(key: key);

  @override
  State<AlarmNotificationScreenTwo2> createState() => _AlarmNotificationScreenTwo2State();
}

class _AlarmNotificationScreenTwo2State extends State<AlarmNotificationScreenTwo2> {
