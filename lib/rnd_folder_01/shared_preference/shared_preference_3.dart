...
///================================================================ complete CRUD of Shared Preference ====================================================================///

class SharedPreferenceThree extends StatefulWidget {
  @override
  _SharedPreferenceThreeState createState() => _SharedPreferenceThreeState();
}

class _SharedPreferenceThreeState extends State<SharedPreferenceThree> {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 20),
            _buildButton('Edit Data', _editData),
            SizedBox(height: 20),
  ...
  void _editData() {
    customerNameController.text = savedCustomerName;
    itemNameController.text = savedItemName;
    itemPriceController.text = savedItemPrice;
  }
